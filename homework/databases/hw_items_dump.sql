...
--
-- Host: localhost    Database: items_hw
-- ------------------------------------------------------
...
CREATE TABLE `phones` (
  `id` int NOT NULL AUTO_INCREMENT,
  `phone_name` char(15) DEFAULT NULL,
...
INSERT INTO `phones` VALUES (1,'xiaomi',1,1),(2,'apple',2,2),(3,'samsung',1,3);
...
-- Dump completed on 2021-10-03 17:31:53
